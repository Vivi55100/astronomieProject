...
<div class="quizGame container-fluid d-flex flex-column">
    <div class="quizQuestion d-flex justify-content-center align-items-center mt-3">
        <h2 class="text-center"><?= $newQuizQuestions[0]["question_content"] ?></h2>
    </div>
    <div class="quizResponse"></div>
</div>
